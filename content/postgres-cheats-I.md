...
-   One table represents one real world object e.g `students table`, `teachers table` e.t.c
-   Columns store one piece of informations. e.g using the `students` table, you might have `name`, `address`.
-   Think about how different tables will relate to each other, e.g how will a `teacher` be matched to the `students` table?
-   Reduce the use of redundant data.
